...
if __name__ == "__main__":
    ...
    parser.add_argument('name', help='the symbol object name or function that generate the symbol in your python file',
                        type=str)
    ...
    parser.add_argument('--func_args', help='args tuple parse to the function, eg. --func_args (3,"ABC")', default='',
                        type=str)
    parser.add_argument('--func_kwargs', help='kwargs dict parse to the function, eg. --func_kwargs {a=1,c="OP"}',
                        default='', type=str)
